...
>
> As duas pendências em "Questões em Aberto" (disponibilidade real de `CustomMessaging` na build
> 2.0.1 do OpenMetadata e o Personal Access Token de escopo mínimo) foram aprovadas para resolução
> **antes/durante a execução de V-06**, não bloqueiam a aprovação desta TechSpec nem o início das
> fatias anteriores.
