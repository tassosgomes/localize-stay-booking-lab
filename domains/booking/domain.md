...
|---|---|---|---|---|---|
| F01 | Solicitação de Reserva | Guest informa Accommodation, período e hóspedes; Booking valida a disponibilidade no Catalog e congela o preço da estadia | Must Have | `prd-ready` | [`tasks/prd-solicitacao-reserva/prd.md`](../../tasks/prd-solicitacao-reserva/prd.md) |
| F02 | Consulta de Reserva | Permite acompanhar dados, estado final e situação da saga de uma Reservation | Must Have | `prd-ready` | — |
| F03 | Solicitação de Pagamento | Inicia a etapa assíncrona da saga para uma Reservation válida e solicitada | Must Have | `prd-ready` | — |
