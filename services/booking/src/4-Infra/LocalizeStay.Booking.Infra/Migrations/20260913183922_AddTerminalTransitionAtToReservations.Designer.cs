...
namespace LocalizeStay.Booking.Infra.Migrations
{
    ...
    [Migration("20260913183922_AddTerminalTransitionAtToReservations")]
    partial class AddTerminalTransitionAtToReservations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LocalizeStay.Booking.Domain.Reservations.Reservation", b =>
                {
                    ...
                    b.Property<DateTime?>("TerminalTransitionAt")
            ...
            modelBuilder.Entity("LocalizeStay.Booking.Domain.Reservations.ReservationSaga", b =>
                {
                    ...
                    b.Property<DateTime?>("PaymentRequestSentAt")
                        .HasColumnType("timestamptz")
